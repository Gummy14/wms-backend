...
namespace WMS_API.Migrations
{
    ...
    [Migration("20250414024318_RenamingStatusToEventType")]
    partial class RenamingStatusToEventType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WMS_API.Models.Events.EventType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 521,
                            EventTypeDescription = "Container Added To Order"
                        },
                        new
                        {
                            Id = 522,
            ...
            modelBuilder.Entity("WMS_API.Models.Containers.ContainerData", b =>
                {
                    ...
                    b.HasOne("WMS_API.Models.Orders.Order", null)
                        .WithOne("ContainerUsedToFulfillOrder")
            ...
            modelBuilder.Entity("WMS_API.Models.Orders.Order", b =>
                {
                    ...
                    b.Navigation("ContainerUsedToFulfillOrder")
                        .IsRequired();
